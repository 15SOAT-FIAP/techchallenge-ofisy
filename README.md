...
| Spring Boot | 4.0.3 | Totalmente compatível com Java 21. Inclui melhorias de performance, atualizações do Spring Framework 6 e suporte a observabilidade e containers. O uso de dependências como o Spring Data JPA facilita o mapeamento entre o domínio da aplicação e a estrutura de dados. |
